                                ...
                                <div class="col-lg-10 col-12 mx-auto">
                                    <form action="index.php?c=usuarios&a=verifLogin" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                        <div class="text-center mb-5">
                                            <h2 class="mb-1">Pedido a domicilio</h2>
                                            <p>Por favor inicia sesion para realizar pedido</p>
                                        </div>
                                        <div class="booking-form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex justify-content-center align-items-center">
                                                    <p style="color:red; background:#CACFD2; padding:15px; border-radius:15px;">El usuario o contraseña son incorrectos.</p>
                                                </div>
                                                ...
                                                <div class="col-12 d-flex justify-content-around align-items-center p-3">
                                                    <a href="index.php?c=WebPage&a=registro">Registro</a>
                                                    <a href="index.php?c=WebPage&a=recuperaContra">¿Olvidaste tu contraseña?</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>

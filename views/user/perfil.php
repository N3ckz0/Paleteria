                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mt-3 mb-3">
                                                <div class="col-lg-10 col-12 custom-block-bg-overlay-wrap me-lg-5 mb-5 mb-lg-0">
                                                    <img src="assets/images/barber/luis.jpg" class="custom-block-bg-overlay-image img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <a href="index.php?c=WebPage&a=modificaPerfilUsuario" class="smoothscroll btn custom-btn custom-btn-italic mt-3">Modificar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
